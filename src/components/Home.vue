...
.nav {
  ...
  height: 60px;
  margin-top: 90px;
  border-top: 2px solid #7b56d3;
  border-bottom: 2px solid #7b56d3;
  display: flex;
  align-items: center;
...
.nav > .icon {
  ...
  margin-right: -20px;
  height: 45px;
  border-top: 20px solid #fed66d;
  border-bottom: 20px solid #fed66d;
}
.nav > .icon > svg {
  width: 45px;
  height: 45px;
...
.user .my-candy {grid-area: a;}
.user .growth {grid-area: b;}
.user .my-candy,
.user .growth {
  width: 125px;
  border-radius: 10px;
  background-color: #7b56d3;
  color: #fff;
  font-weight: bold;
  font-size: 20px;
  padding: 10px 20px;
...
.user .upload-img {
  ...
  height: var(--side);
  border-radius: 20px;
  border: 4px dashed #7b56d3;
  position: relative;
  cursor: pointer;
}
.user .upload-img > span {
  --border-color: #7b56d3;
  color: #ffd86d;
  font-size: 16px;
  text-shadow:
...
.user .upload-img > input[type="file"] {
  opacity: 0;
  width: 100%;
  height: 100%;
  top: 0;
...
.rank-content li > span:nth-of-type(1),
.rank-content li > span:nth-of-type(2) {
  padding-right: 14px;
}

.rank-content li > .pentagram svg {
  --side: 35px;
  width: var(--side);
  height: var(--side);
}
